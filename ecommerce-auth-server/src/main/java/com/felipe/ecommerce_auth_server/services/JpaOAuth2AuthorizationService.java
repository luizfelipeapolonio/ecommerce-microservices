...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
  ...
  private OAuth2Authorization toObject(AuthorizationEntity authorizationEntity) {
    RegisteredClient registeredClient = this.registeredClientRepository.findById(authorizationEntity.getRegisteredClientId());
    if(registeredClient == null) {
      throw new DataRetrievalFailureException(
        "The RegisteredClient with id '" + authorizationEntity.getRegisteredClientId() +
    ...
    OAuth2Authorization.Builder builder = OAuth2Authorization.withRegisteredClient(registeredClient)
      ...
      .authorizationGrantType(resolveAuthorizationGrantType(authorizationEntity.getAuthorizationGrantType()))
      .authorizedScopes(StringUtils.commaDelimitedListToSet(authorizationEntity.getAuthorizedScopes()))
      .attributes(attributes -> attributes.putAll(parseMap(authorizationEntity.getAttributes())));
    ...
    if(authorizationEntity.getAuthorizationCodeValue() != null) {
      ...
      builder.token(authorizationCode, metadata -> metadata.putAll(parseMap(authorizationEntity.getAuthorizationCodeMetadata())));
    }
    ...
    if(authorizationEntity.getAccessTokenValue() != null) {
      OAuth2AccessToken accessToken = new OAuth2AccessToken(
        ...
        StringUtils.commaDelimitedListToSet(authorizationEntity.getAccessTokenScopes())
      );
      builder.token(accessToken, metadata -> metadata.putAll(parseMap(authorizationEntity.getAccessTokenMetadata())));
    }
    ...
    if(authorizationEntity.getRefreshTokenValue() != null) {
      ...
      builder.token(refreshToken, metadata -> metadata.putAll(parseMap(authorizationEntity.getRefreshTokenMetadata())));
    }
    ...
    if(authorizationEntity.getOidcIdTokenValue() != null) {
      ...
      builder.token(idToken, metadata -> metadata.putAll(parseMap(authorizationEntity.getOidcIdTokenMetadata())));
    }

    if(authorizationEntity.getUserCodeValue() != null) {
      ...
      builder.token(userCode, metadata -> metadata.putAll(parseMap(authorizationEntity.getUserCodeMetadata())));
    }

    if(authorizationEntity.getDeviceCodeValue() != null) {
      ...
      builder.token(deviceCode, metadata -> metadata.putAll(parseMap(authorizationEntity.getDeviceCodeMetadata())));
    }
