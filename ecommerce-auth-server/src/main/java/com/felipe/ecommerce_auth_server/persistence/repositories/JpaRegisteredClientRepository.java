...
public class JpaRegisteredClientRepository implements RegisteredClientRepository {
  ...
  private RegisteredClient toObject(ClientEntity clientEntity) {
    ...
    Set<String> postLogoutRedirectUris = StringUtils.commaDelimitedListToSet(clientEntity.getPostLogoutRedirectUris());
  ...
  private ClientEntity toEntity(RegisteredClient registeredClient) {
    ...
    clientEntity.setClientIdIssuedAt(registeredClient.getClientIdIssuedAt());
    clientEntity.setClientSecret(registeredClient.getClientSecret());
    clientEntity.setClientSecretExpiresAt(registeredClient.getClientSecretExpiresAt());
    clientEntity.setClientName(registeredClient.getClientName());
    clientEntity.setClientAuthenticationMethods(StringUtils.collectionToCommaDelimitedString(clientAuthenticationMethods));
    clientEntity.setAuthorizationGrantTypes(StringUtils.collectionToCommaDelimitedString(authorizationGrantTypes));
    clientEntity.setRedirectUris(StringUtils.collectionToCommaDelimitedString(registeredClient.getRedirectUris()));
    clientEntity.setPostLogoutRedirectUris(StringUtils.collectionToCommaDelimitedString(registeredClient.getPostLogoutRedirectUris()));
    clientEntity.setScopes(StringUtils.collectionToCommaDelimitedString(registeredClient.getScopes()));
    clientEntity.setClientSettings(writeMap(registeredClient.getClientSettings().getSettings()));
    clientEntity.setTokenSettings(writeMap(registeredClient.getTokenSettings().getSettings()));
