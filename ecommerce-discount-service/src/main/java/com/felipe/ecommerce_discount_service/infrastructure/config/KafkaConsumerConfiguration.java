...
public class KafkaConsumerConfiguration {
  ...
  public ConsumerFactory<String, Object> consumerFactory() {
    ...
    configs.put(ConsumerConfig.GROUP_ID_CONFIG, "discount-service");
  ...
  private static String typeMappings() {
    String[] types = {
      "discountTransactionCreateCommand:com.felipe.kafka.saga.commands.DiscountTransactionCreateCommand"
    };
